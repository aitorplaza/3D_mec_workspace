...
print("==========================================================")
print("  4-Bar Linkage Multibody Model - Symbolic Derivation")
print("==========================================================")

print("\n--> [1/8] Configuring system settings & gravity...")
set_gravity_direction('up')
#set_atomization_state(False)
warnings.filterwarnings('ignore')


print("--> [2/8] Defining generalized coordinates, velocities & accelerations...")
...
print("--> [3/8] Setting up kinematical, dynamical parameters & bases...")
...
print("--> [4/8] Creating position vectors, points, frames & inertia tensors...")
...
print("--> [5/8] Formulating wrenches (gravity, inertia, forces, springs)...")
K = new_param('K', 50)
l2x = new_param('l2x', 1)
...
print("--> [6/8] Deriving kinematic constraint equations (Phi, Jacobians, Beta, Gamma)...")
...
print("--> [7/8] Deriving equations of motion (M_qq mass matrix & delta_q forces)...")
Dyn_eq_VP = Matrix([
...
export_numeric_func_python(Phi, 'Phi_', 'Phi_out')
export_numeric_func_python(Phi_q, 'Phi_q_', 'Phi_q_out')
export_numeric_func_python(dPhi_dq, 'dPhi_dq_', 'dPhi_dq_out')
export_numeric_func_python(beta, 'beta_', 'beta_out')
export_numeric_func_python(gamma, 'gamma_', 'gamma_out')
export_numeric_func_python(Phi_init, 'Phi_init_', 'Phi_init_out')
export_numeric_func_python(Phi_init_q, 'Phi_init_q_', 'Phi_init_q_out')
export_numeric_func_python(dPhi_init_dq, 'dPhi_init_dq_', 'dPhi_init_dq_out')
export_numeric_func_python(beta_init, 'beta_init_', 'beta_init_out')
export_numeric_func_python(M_qq, 'M_qq_', 'M_qq_out')
export_numeric_func_python(delta_q, 'delta_q_', 'delta_q_out')

print("\n==========================================================")
print("  Symbolic derivation & exports finished successfully!")
print("==========================================================")
